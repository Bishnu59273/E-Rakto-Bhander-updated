...
<body>
    <nav class="sidebar close">
        ...
        <div class="menu-bar">
            <div class="menu">
                <li class="search-box">
                    <a href="FreamePages/Organization-profile.php" target="p_window">
                ...
                <li class="search-box">
                    <a href="FreamePages/donersettings.php" target="p_window">
    ...
    <section class="home">
        <div class="text">
            ...
            <div>
                <iframe src="FreamePages/Organization-profile.php" width=100% height=1000 name="p_window"></iframe>
            </div>
        </div>
    </section>
